...
enum
{
	...
	INFWEAPON_NINJA_RIFLE,
	
	INFWEAPON_MERCENARY_GUN,
	INFWEAPON_MERCENARY_GRENADE,

	INFWEAPON_SCIOGIST_SHOTGUN,
	INFWEAPON_SCIOGIST_GRENADE,
	INFWEAPON_SCIOGIST_RIFLE,

	INFWEAPON_CATAPULT_GRENADE,
	INFWEAPON_CATAPULT_RIFLE,
	INFWEAPON_CATAPULT_GUN,

	INFWEAPON_POLICE_HAMMER,
	...
	INFWEAPON_MAGICIAN_GUN,
	INFWEAPON_MAGICIAN_SHOTGUN,
	INFWEAPON_MAGICIAN_GRENADE,

	INFWEAPON_ARTILLERY_SHOTGUN,
	INFWEAPON_ARTILLERY_GRENADE,
	INFWEAPON_ARTILLERY_RIFLE,

	INFWEAPON_SLIME_HAMMER,

	INFWEAPON_DOCTOR_HAMMER,
	INFWEAPON_DOCTOR_SHOTGUN,
	INFWEAPON_DOCTOR_GRENADE,
	INFWEAPON_DOCTOR_RIFLE,
