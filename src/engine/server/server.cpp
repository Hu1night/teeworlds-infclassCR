...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_ARTILLERY_SHOTGUN, 500);
	SetFireDelay(INFWEAPON_ARTILLERY_GRENADE, 400);
	SetFireDelay(INFWEAPON_ARTILLERY_RIFLE, 500);

	SetFireDelay(INFWEAPON_SCIOGIST_RIFLE, 250);
	...
	SetFireDelay(INFWEAPON_CATAPULT_GUN, 300);
	...
	SetAmmoRegenTime(INFWEAPON_ARTILLERY_SHOTGUN, 1500);
	SetAmmoRegenTime(INFWEAPON_ARTILLERY_GRENADE, 2500);
	SetAmmoRegenTime(INFWEAPON_ARTILLERY_RIFLE, 5000);
	...
	SetAmmoRegenTime(INFWEAPON_CATAPULT_RIFLE, 1500);
	SetAmmoRegenTime(INFWEAPON_CATAPULT_GRENADE, 750);
	SetAmmoRegenTime(INFWEAPON_CATAPULT_GUN, 1500);
	...
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_GUN, 2500);
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_SHOTGUN, 750);
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_GRENADE, 40000);
	...
	SetMaxAmmo(INFWEAPON_CATAPULT_GUN, 5);
	...
	SetMaxAmmo(INFWEAPON_ARTILLERY_SHOTGUN, 10);
	SetMaxAmmo(INFWEAPON_ARTILLERY_GRENADE, 8);
	SetMaxAmmo(INFWEAPON_ARTILLERY_RIFLE, 5);
	...
	SetMaxAmmo(INFWEAPON_MAGICIAN_GUN, 5);
	SetMaxAmmo(INFWEAPON_MAGICIAN_SHOTGUN, 10);
	SetMaxAmmo(INFWEAPON_MAGICIAN_GRENADE, 1);
	...
	SetClassAvailability(PLAYERCLASS_ARTILLERY, 2);
...
void CServer::SendCapabilities(int ClientID)
{
	...
	Msg.AddInt(SERVERCAPFLAG_ANYPLAYERFLAG | SERVERCAPFLAG_PINGEX | SERVERCAPFLAG_SYNCWEAPONINPUT); // flags
	SendMsg(&Msg, MSGFLAG_VITAL, ClientID);
}
