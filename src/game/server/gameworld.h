...
public:
	enum
	{
		...
		ENTTYPE_ELASTIC_GRENADE,
		ENTTYPE_CATAPULT_GUN,
		ENTTYPE_MEDIC_GRENADE,
		ENTTYPE_SCIOGIST_GRENADE,
		ENTTYPE_HERO_FLAG,
		...
		ENTTYPE_PLASMA,
		ENTTYPE_PLASMA_PLUS,
		ENTTYPE_ELASTIC_HOLE,
		ENTTYPE_ELASTIC_ENTITY,
		ENTTYPE_SLIME_ENTITY,
		ENTTYPE_POLICE_SHIELD,
		ENTTYPE_REVIVER_GRENADE,
		ENTTYPE_HEAL_BOOM,
		ENTTYPE_ANTI_AIRMINE,
		ENTTYPE_FREEZE_MINE,
		ENTTYPE_ARTILLERY_PROJECTILE,
		ENTTYPE_ARTILLERY_LASER,
		ENTTYPE_DOCTOR_GRENADE,
		ENTTYPE_DOCTOR_FUNNEL,
